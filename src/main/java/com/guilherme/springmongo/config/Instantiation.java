...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p2 = new Post(null, sdf.parse( "21/03/2018"),  "Bora lá",  "Bora para São Paulo.!", new AuthorDTO( alex ));
		Post p3 = new Post(null, sdf.parse( "21/03/2018"),  "Sou foda",  "Consegui terminar o cusro!", new AuthorDTO ( maria ));
